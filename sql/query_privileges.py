...
from sql.utils.resource_group import user_groups, user_instances,all_instances
...
def query_priv_apply(request):
    ...
    try:
        pass
        ##all_instances(request.user,group_name,tag_codes=['can_read']).get(instance_name=instance_name)

...
def get_engine(instance=None):  # pragma: no cover
    ...
    elif instance.db_type == 'drds':
        from .drds import DRDSEngine
        return DRDSEngine(instance=instance)
##    elif instance.db_type == 'tidb':
##        from .tidb import TiDBEngine
##        return TiDBEngine(instance=instance)
    elif instance.db_type == 'mycat':
        from .mycat import MyCatEngine
        return MyCatEngine(instance=instance)

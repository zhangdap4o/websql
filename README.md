...
[![Release](https://img.shields.io/github/release/hhyo/archery.svg)](https://github.com/kevinkelly/websql/releases/)
[![codecov](https://codecov.io/gh/kevinkelly/websql/branch/master/graph/badge.svg)](https://codecov.io/gh/hhyo/archery)
...
[![docker_pulls](https://img.shields.io/docker/pulls/hhyo/archery.svg)](https://hub.docker.com/r/kevinkelly/websql/)
[![HitCount](http://hits.dwyl.io/hhyo/hhyo/Archery.svg)](http://hits.dwyl.io/hhyo/hhyo/Archery)
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](http://github.com/kevinkelly/websql/blob/master/LICENSE)
[![996.icu](https://img.shields.io/badge/link-996.icu-red.svg)](https://996.icu)

[文档](https://github.com/kevinkelly/websql/wiki) | [FAQ](https://github.com/kevinkelly/websql/wiki/FAQ) | [Releases](https://github.com/kevinkelly/websql/releases/)
...
介绍
============
websql是[archer](https://github.com/jly8866/archer)的分支项目，定位于SQL审核查询平台，旨在提升DBA的工作效率，支持主流数据库的SQL上线和查询，同时支持丰富的MySQL运维功能，所有功能都兼容手机端操作，查看[功能和支持列表](https://github.com/kevinkelly/websql/wiki/功能列表)

开发计划
==============
https://github.com/kevinkelly/websql/projects   
...
### Docker
#### 准备运行配置
具体可参考：https://github.com/kevinkelly/websql/tree/master/src/docker-compose    

#### 启动
下载 [Releases](https://github.com/kevinkelly/websql/releases/)文件，解压后进入docker-compose文件夹
...
手动安装
===============
[部署说明](https://github.com/kevinkelly/websql/wiki/部署#手动部署)
...
贡献者
===============
[![](https://sourcerer.io/fame/hhyo/kevinkelly/websql/images/0)](https://sourcerer.io/fame/hhyo/kevinkelly/websql/links/0)[![](https://sourcerer.io/fame/hhyo/kevinkelly/websql/images/1)](https://sourcerer.io/fame/hhyo/kevinkelly/websql/links/1)[![](https://sourcerer.io/fame/hhyo/kevinkelly/websql/images/2)](https://sourcerer.io/fame/hhyo/kevinkelly/websql/links/2)[![](https://sourcerer.io/fame/hhyo/kevinkelly/websql/images/3)](https://sourcerer.io/fame/hhyo/kevinkelly/websql/links/3)[![](https://sourcerer.io/fame/hhyo/kevinkelly/websql/images/4)](https://sourcerer.io/fame/hhyo/kevinkelly/websql/links/4)[![](https://sourcerer.io/fame/hhyo/kevinkelly/websql/images/5)](https://sourcerer.io/fame/hhyo/kevinkelly/websql/links/5)[![](https://sourcerer.io/fame/hhyo/kevinkelly/websql/images/6)](https://sourcerer.io/fame/hhyo/kevinkelly/websql/links/6)[![](https://sourcerer.io/fame/hhyo/kevinkelly/websql/images/7)](https://sourcerer.io/fame/hhyo/kevinkelly/websql/links/7)
...
问题反馈
===============
[Issues](https://github.com/kevinkelly/websql/issues)是本项目唯一的沟通渠道，如果在使用过程中遇到问题，请先查阅文档，如果仍无法解决，请查看相关日志，保存截图信息，给我们提交[Issue](https://github.com/kevinkelly/websql/issues)，请按照模板提供相关信息，否则会被直接关闭，感谢理解

...
一个较为规范的建表语句为：
 CREATE TABLE channel_order_log (
   id bigint(20) NOT NULL DEFAULT 0 COMMENT 'id',
   order_no bigint(20) NOT NULL DEFAULT 0 COMMENT '订单号',
   outside_no varchar(50) NOT NULL DEFAULT '' COMMENT '外部订单号',
   order_channel tinyint(2) NOT NULL DEFAULT NULL COMMENT '订单来源',
   source_zone_name varchar(100) NOT NULL DEFAULT '' COMMENT '始发网点名称',
   source_zone_code varchar(50) NOT NULL DEFAULT '' COMMENT '始发网点编码',
   customer_code varchar(50) NOT NULL DEFAULT '' COMMENT '用户编码',
   is_delete tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除 0未删除；1 已删除，默认0',
   creater varchar(50) NOT NULL DEFAULT '' COMMENT '创建人',
   create_time datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
   modifier varchar(50) NOT NULL DEFAULT '' COMMENT '修改人',
   modifier_time datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
   latest_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
   record_version decimal(10,0) DEFAULT NULL COMMENT '版本号',
   column1 varchar(100) NOT NULL DEFAULT '' COMMENT '扩展字段1',
   column2 varchar(100) NOT NULL DEFAULT '' COMMENT '扩展字段2',
   column3 varchar(100) NOT NULL DEFAULT '' COMMENT '扩展字段3',
   column4 varchar(100) NOT NULL DEFAULT '' COMMENT '扩展字段4',
   column5 varchar(100) NOT NULL DEFAULT '' COMMENT '扩展字段5',
   PRIMARY KEY (id),
   UNIQUE KEY uniq_source_zone_code (source_zone_code),
